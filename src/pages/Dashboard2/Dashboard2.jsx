...
import {
  calculateCOP,
  calculateConnectiveHT,
  calculateReynoldsNumber,
  calculateEfficiency,
  calculatePrRatio,
  calculateSpStRatio,
  calculateMachNumber,
  calculateSpecificImpulse,
} from "./formulas";
...
const Dashboard2 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("arduino-data", (data) => {
      ...
      const newCOP = calculateCOP(
        connectiveHT,
        efficiency,
        arduinoData.outletTemp,
        arduinoData.blowerPressure,
      ...
      // Calculate and update other values here
      const newConnectiveHT = calculateConnectiveHT(
        arduinoData.outletTemp,
        tempAtCC,
        arduinoData.exhaustPressure
      );
      ...
      const newSpStRatio = calculateSpStRatio(
        arduinoData.inletTemp,
        arduinoData.outletTemp,
        arduinoData.blowerPressure,
        arduinoData.exhaustPressure
      ...
      const newSpecificImpulse = calculateSpecificImpulse(
        arduinoData.exhaustPressure,
        arduinoData.fuelIntake
      );
      setSpecificImpulse(newSpecificImpulse);
        ...
        <div className="Value_Section">
          <div className="Values">
            ...
            <div className="Value">
              ...
              <img src={critical > connectiveHT ? Up : Down} alt="Arrow UP" />
            </div>
            <div className="Value">
              <h2>Exit Velocity :</h2>
              <div className="Case_Box">
              ...
              <img src={critical > exitVelocity ? Up : Down} alt="Arrow UP" />
            </div>
            <div className="Value">
              ...
              <img src={critical > reynoldsNumber ? Up : Down} alt="Arrow UP" />
            </div>
            <div className="Value">
              <h2>Efficiency :</h2>
              <div className="Case_Box">
              ...
              <img src={critical > efficiency ? Up : Down} alt="Arrow UP" />
            </div>
            <div className="Value">
              ...
              <img src={critical > prRatio ? Up : Down} alt="Arrow UP" />
            </div>
            <div className="Value">
              <h2>δP/δT Ratio :</h2>
              <div className="Case_Box">
              ...
              <img src={critical > spStRatio ? Up : Down} alt="Arrow UP" />
            </div>
            <div className="Value">
              <h2>Mach Number :</h2>
              <div className="Case_Box">
              ...
              <img src={critical > machNumber ? Up : Down} alt="Arrow UP" />
            </div>
            <div className="Value">
            ...
            <div className="Value">
              ...
              <img src={critical > phaseShift ? Up : Down} alt="Arrow UP" />
            </div>
          </div>
        </div>
            ...
            <Line
              ...
              options={{
                ...
                plugins: {
                  ...
                  title: {
                    display: true,
                    text: "Outlet Temperature Vs Exhaust Pressure",
                  },
                },
                scales: {
                  x: {
